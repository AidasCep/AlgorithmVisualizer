...
const SortingAlgorithmPage = () => {
    ...
    const sort = useCallback(
        async (GetSort: (array: number[]) => { type: string; indices: number[]; values?: number[] }[]) => {
            ...
            const animate = () => {
                ...
                while (processedSteps < steps && index < animations.length) {
                    ...
                    if (type === 'compare') {
                        ...
                        barStyle.backgroundColor = OVERWRITE_COLOR;
                ...
                <div className="w-full lg:w-80 bg-base-100 rounded-lg shadow-lg p-6 flex-shrink-0">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-1 gap-2">
                            <button className="btn btn-primary btn-sm" onClick={() => sort(GetBubbleSortAnimations)}>
                                Bubble Sort
                            </button>
                            <button
                            ...
                            <button className="btn btn-accent btn-sm" onClick={() => sort(GetInsertionSortAnimations)}>
                                Insertion Sort
                            </button>
                            <button className="btn btn-info btn-sm" onClick={() => sort(GetGnomeSortAnimations)}>
                                Gnome Sort
                            </button>
                            <button className="btn btn-success btn-sm" onClick={() => sort(GetMergeSortAnimations)}>
                                Merge Sort
                            </button>
                            <button className="btn btn-warning btn-sm" onClick={() => sort(GetQuickSortAnimations)}>
                                Quick Sort
                            </button>
                            <button className="btn btn-error btn-sm" onClick={() => sort(GetHeapSortAnimations)}>
                                Heap Sort
                            </button>
                            <button className="btn btn-neutral btn-sm" onClick={() => sort(GetRadixSortAnimations)}>
                                Radix Sort
                            </button>
                        </div>
                    </div>
